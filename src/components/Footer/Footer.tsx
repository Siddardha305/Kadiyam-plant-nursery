            ...
            <div className="footer-content">
                ...
                <div className="footer-column">
                    ...
                    <ul className="footer-contact">
                        ...
                        <li><FaPhoneAlt className="footer-icon" /> +91 9553244660</li>
                        <li><FaEnvelope className="footer-icon" /> kadiyamplants.support@gamil.com</li>
                    </ul>
                </div>
                <div className="footer-column">
                    ...
                    <div className="social-icons">
                        ...
                        <a href="https://www.instagram.com/kadiyam_plants_nurseries?utm_source=qr&igsh=Y2ZhcG85aXpucDcw" target="_blank" rel="noreferrer" className="social-icon"><FaInstagram /></a>
